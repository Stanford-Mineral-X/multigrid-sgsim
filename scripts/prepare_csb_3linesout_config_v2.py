#!/usr/bin/env python
"""
Prepare MGSIM Configuration for CSB with 3 flight lines held out — V2
...
Usage:
    ...
    python prepare_csb_3linesout_config_v2.py  # then, create the config
"""
...
# =============================================================================
# USER PARAMETERS — only differences from prepare_csb_config_v2.py noted
# =============================================================================
...
# Trend parameters — V2: smoother trend
SMOOTHING = 10000.0
SPACING_FL = 1000
...
ENSEMBLE_NAME = 'csb_sph_iso_3linesout_v2'
...
def main():
    print("=" * 70)
    print("CSB MGSIM CONFIG — 3 FLIGHT LINES HELD OUT — V2")
    ...
    print("     sbatch submit_csb_3linesout_mgsim_v2.sbatch")
