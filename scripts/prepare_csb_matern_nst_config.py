#!/usr/bin/env python
"""
Prepare MGSIM Configuration for CSB — full dataset (no holdout).
...
Usage:
    python prepare_csb_matern_nst_config.py
"""
...
# Data path (full dataset — no lines withheld)
...
def main():
    print("=" * 70)
    print("CSB MGSIM CONFIG — MATERN + NST — FULL DATASET")
    ...
    # 1. LOAD DATA
    # =====================================================================
    print("\n1. Loading CSB data (full dataset)...")
    ...
    print("     sbatch submit_csb_matern_nst_mgsim.sbatch")
