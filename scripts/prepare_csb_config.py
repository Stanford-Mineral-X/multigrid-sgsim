#!/usr/bin/env python
"""
Prepare MGSIM Configuration for Cape Smith Belt (CSB) Real Dataset

Creates a configuration file for running 1000 realizations with:
- Spherical isotropic variograms
- 10 clusters (subregions mode)
- RBF trend surface

Mirrors the workflow in demo_capesmith_mgsim_rev.ipynb.

Usage:
    python prepare_csb_config.py
"""
...
def main():
    print("=" * 70)
    print("CSB MGSIM CONFIGURATION GENERATOR")
    print("=" * 70)
    ...
    print("     sbatch submit_csb_mgsim.sbatch")
